      ...
      <div className="container">
        ...
        <div className="about-grid">
          ...
          <div className="about-text fade-up">
            ...
            <p>Durante estos dos años de formación intensiva he aprendido que <strong>me encanta el frontend tanto como el backend</strong> — soy genuinamente full-stack, del píxel a la base de datos.</p>
